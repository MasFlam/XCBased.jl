function change_gc(
	...
	value_mask = UInt32(0)
	# xcb_change_gc_value_list_t and xcb_create_gc_value_list_t are the same
	value_list = Ref{LibXCB.xcb_change_gc_value_list_t}()
	...
	fn = checked ? LibXCB.xcb_change_gc_aux_checked : LibXCB.xcb_change_gc_aux
	cookie = fn(
		conn.handle,
		gc,
		drawable,
